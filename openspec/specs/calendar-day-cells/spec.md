...
Defines the shared builder and hook that assemble per-day calendar cell data from blocks, logs, categories, and profile. Extracted from the Week view so any calendar view can consume consistent cell data without duplicating computation logic.
